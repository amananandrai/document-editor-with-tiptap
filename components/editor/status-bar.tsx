...
import { FileText, MousePointer, Type } from "lucide-react";
...
export function StatusBar({ editor }: StatusBarProps) {
  ...
  return (
    <div className="sticky bottom-0 z-40 w-full flex flex-col lg:flex-row items-center md:justify-between gap-y-2 lg:gap-y-0 px-4 py-2 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 text-sm text-gray-600 dark:text-gray-300">
